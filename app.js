...
console.log("Número de explorers en Node:" + explorersInNode.length)

// Part4: Get the explorer's usernames in Node
const explorersInNodeToGetUsernames = explorers.filter((explorer) => explorer.mission == "node");
const usernamesInNode = explorersInNodeToGetUsernames.map((explorer) => explorer.githubUsername);
console.log("Los explorers en Node son:" + usernamesInNode)
...
console.log(explorersInNodeAndFizzTrick) //Imprime a los explorers con puntaje divisible entre 3
...
console.log(explorersInNodeAndBuzzTrick) // Imprime a los explorers con puntaje divisible entre 5
...
console.log(explorersInNodeAndFizzBuzzTrick) //Imprime a los explorers con puntaje divisible entre 3 y 5
